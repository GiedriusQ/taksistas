var board, num_red_pieces, num_black_pieces, player, current_move, canvas, context, myy_turn;

function NewGame(layout, red, black, my_turn, red_turn) {
    canvas = $('#checkers')[0];
    context = canvas.getContext('2d');
    board = layout;
    num_red_pieces = red;
    num_black_pieces = black;
    player = red_turn ? 1 : -1;
    myy_turn = my_turn;
    current_move = [];
    DrawBoard();
...
function DrawInterface() {
    ...
    context.fillText(myy_turn ? 'Your Turn' : 'Opponent\'s Turn', 10, 340);
